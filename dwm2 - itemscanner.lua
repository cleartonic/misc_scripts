...
filename = "dumps/dwm2-pirateitems_a.txt"
readdata = 0
iteration = 1
...
function checkplace()
	if (memory.readbyte(0x019E) == 42) then
		emu.frameadvance()
		emu.frameadvance()
		emu.frameadvance()
		emu.frameadvance()
		...
		io.output(file)
		io.write(iteration,',',emu.framecount()-30,',',itemID1,',',itemID2,',',itemID3,',',itemID4,',',itemID5,',',itemID6,',')
		io.write(iteration)
		io.write("\n")
		io.close()
